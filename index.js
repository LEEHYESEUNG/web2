...
$('.visual-area .link-slide').click(function(e){
  ...
  if ($(this).parent().hasClass('visual-slide1')) {
    ...
    //     if(slide != 'slide-top-item'){
    //         $('.slide-top').hide();
    //     }
    //     $(this).siblings('.swiper').show();
    //     $(this).addClass('active');
    //     $(this).parent().siblings().find('.link-slide').removeClass('active');
    // });
...
// 내가 한 방법
// display = $(this).parent().find('.sub-organization').css('display');

// if( display == 'none'){
//     $('.btn-organization').removeClass('on');
//     $('.organization-item').removeClass('on');
//     $('.btn-organization').parent().find('.sub-organization').stop().slideUp(); 
    
//     $(this).addClass('on');
//     $(this).parent().addClass('on');
//     $(this).parent().find('.sub-organization').stop().slideDown();
// }else{
//     $(this).removeClass('on');
//     $(this).parent().removeClass('on');
//     $(this).parent().find('.sub-organization').stop().slideUp();
// }   
